...
})({"kMjvB":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "ceedcaf9b038fe07";
"use strict";
...
const makeMaket = (users)=>{
    return users.map((user)=>{
        return `<li class="userBasa">
  <h1 class="userTitle">${user.login}</h1>,
   <p class="userId">${user.id}</p>,
    <p class="userNode"Ig >${user.node_id}</p>,
